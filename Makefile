...
API_SRCS := $(call rwildcard,./cmd/clusterawsadm/api,*.go) $(call rwildcard,./api,*.go) $(call rwildcard,./exp/api,*.go) $(call rwildcard,./controlplane/eks/api,*.go) $(call rwildcard,./iam/api,*.go)
