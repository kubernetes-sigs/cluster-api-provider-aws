...
func (t Template) policyFunctionMap() map[PolicyName]func() *v1beta1.PolicyDocument {
...
func (t Template) GetPolicyDocFromPolicyName(policyName PolicyName) *v1beta1.PolicyDocument {
