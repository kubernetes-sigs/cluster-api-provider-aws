...
func newBootstrapTemplate(e2eCtx *E2EContext) *cfn_bootstrap.Template {
	...
	t.Spec.BootstrapUser.ExtraStatements = []v1beta1.StatementEntry{
		{
			Effect: "Allow",
	...
	t.Spec.SecureSecretsBackends = []v1beta1.SecretBackend{
		v1beta1.SecretBackendSecretsManager,
		v1beta1.SecretBackendSSMParameterStore,
	}
...
func appendExtraPoliciesToBootstrapUser(t *cfn_bootstrap.Template) {
	t.Spec.BootstrapUser.ExtraStatements = append(t.Spec.BootstrapUser.ExtraStatements, v1beta1.StatementEntry{
...
func appendMultiTenancyRoles(t *cfn_bootstrap.Template, cfnt *cloudformation.Template) {
	...
	cfnt.Resources[MultiTenancyJumpPolicy] = &cfn_iam.ManagedPolicy{
		...
		PolicyDocument: &v1beta1.PolicyDocument{
			Version: v1beta1.CurrentVersion,
			Statement: []v1beta1.StatementEntry{
				{
					Effect:   v1beta1.EffectAllow,
					Resource: v1beta1.Resources{cloudformation.GetAtt(MultiTenancyNestedRole.RoleName(), "Arn")},
