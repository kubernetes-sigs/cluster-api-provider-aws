...
var _ = ginkgo.Describe("[managed] [general] EKS clusterclass managed machine pool tests", func() {
	...
	ginkgo.It("should create a workload cluster with a managed machine pool", func() {
		configCluster := defaultConfigCluster(clusterName, namespace.Name)
		configCluster.Flavor = EKSClusterClassManagedMachinePoolFlavor
