...
func init() {
	...
	flag.BoolVar(&enableGCTests, "enable-eks-extresourcegc-tests", false, "if true, the EKS external resource gc tests will be run.")
}
...
func runGCTests() bool {
	return enableGCTests
}
