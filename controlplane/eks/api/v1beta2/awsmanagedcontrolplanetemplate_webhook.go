...
// Ensure AWSManagedControlPlaneTemplate implements the Defaulter and Validator interfaces.
...
func (r *AWSManagedControlPlaneTemplate) ValidateCreate() (admission.Warnings, error) {
...
func (r *AWSManagedControlPlaneTemplate) ValidateUpdate(old runtime.Object) (admission.Warnings, error) {
	mcpLog.Info("AWSManagedControlPlaneTemplate validate update", "control-plane-template", klog.KObj(r))
...
func (r *AWSManagedControlPlaneTemplate) ValidateDelete() (admission.Warnings, error) {
...
func (r *AWSManagedControlPlaneTemplate) Default() {
	mcpLog.Info("AWSManagedControlPlaneTemplate setting defaults", "control-plane", klog.KObj(r))
