...
func Convert_v1alpha3_Network_To_v1alpha4_Network(in *infrav1alpha3.Network, out *infrav1alpha4.Network, s apiconversion.Scope) error {
	return infrav1alpha3.Convert_v1alpha3_Network_To_v1alpha4_Network(in, out, s)
}

// Convert_v1alpha4_Network_To_v1alpha3_Network is an autogenerated conversion function.
func Convert_v1alpha4_Network_To_v1alpha3_Network(in *infrav1alpha4.Network, out *infrav1alpha3.Network, s apiconversion.Scope) error {
	return infrav1alpha3.Convert_v1alpha4_Network_To_v1alpha3_Network(in, out, s)
}
