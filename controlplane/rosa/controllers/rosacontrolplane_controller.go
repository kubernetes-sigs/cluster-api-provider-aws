...
func (r *ROSAControlPlaneReconciler) updateOCMClusterSpec(rosaControlPlane *rosacontrolplanev1.ROSAControlPlane, cluster *cmv1.Cluster) (ocm.Spec, bool) {
	...
	if rosaControlPlane.Spec.CloudWatchLogForwarder != nil && ocmClusterSpec.CloudWatchLogForwarder != nil {
		...
		if !reflect.DeepEqual(ocmClusterSpec.CloudWatchLogForwarder.GroupsLogVersions, rosaControlPlane.Spec.CloudWatchLogForwarder.GroupsLogVersions) {
			ocmClusterSpec.CloudWatchLogForwarder.GroupsLogVersions = rosaControlPlane.Spec.CloudWatchLogForwarder.GroupsLogVersions
			updated = true
		}
		...
		ocmClusterSpec.CloudWatchLogForwarder = &logforwarding.CloudWatchLogForwarderConfig{
			...
			GroupsLogVersions:      rosaControlPlane.Spec.CloudWatchLogForwarder.GroupsLogVersions,
	...
	if rosaControlPlane.Spec.S3LogForwarder != nil && ocmClusterSpec.S3LogForwarder != nil {
		...
		if !reflect.DeepEqual(ocmClusterSpec.S3LogForwarder.GroupsLogVersions, rosaControlPlane.Spec.S3LogForwarder.GroupsLogVersions) {
			ocmClusterSpec.S3LogForwarder.GroupsLogVersions = rosaControlPlane.Spec.S3LogForwarder.GroupsLogVersions
			updated = true
		}
		...
		ocmClusterSpec.S3LogForwarder = &logforwarding.S3LogForwarderConfig{
			...
			GroupsLogVersions:    rosaControlPlane.Spec.S3LogForwarder.GroupsLogVersions,
			S3ConfigBucketName:   rosaControlPlane.Spec.S3LogForwarder.S3ConfigBucketName,
			S3ConfigBucketPrefix: rosaControlPlane.Spec.S3LogForwarder.S3ConfigBucketPrefix,
		}
		updated = true
	} else if rosaControlPlane.Spec.S3LogForwarder == nil && ocmClusterSpec.S3LogForwarder != nil {
...
func buildOCMClusterSpec(controlPlaneSpec rosacontrolplanev1.RosaControlPlaneSpec, roleConfig *expinfrav1.ROSARoleConfig, rosaNet *expinfrav1.ROSANetwork, creator *rosaaws.Creator) (ocm.Spec, error) {
	...
	if controlPlaneSpec.CloudWatchLogForwarder != nil {
		ocmClusterSpec.CloudWatchLogForwarder = &logforwarding.CloudWatchLogForwarderConfig{
			...
			GroupsLogVersions:      controlPlaneSpec.CloudWatchLogForwarder.GroupsLogVersions,
		}
	}
	...
	if controlPlaneSpec.S3LogForwarder != nil {
		ocmClusterSpec.S3LogForwarder = &logforwarding.S3LogForwarderConfig{
			...
			GroupsLogVersions:    controlPlaneSpec.S3LogForwarder.GroupsLogVersions,
