...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *LogForwarderConfig) DeepCopyInto(out *LogForwarderConfig) {
	*out = *in
	...
	if in.GroupsLogVersion != nil {
		in, out := &in.GroupsLogVersion, &out.GroupsLogVersion
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new LogForwarderConfig.
func (in *LogForwarderConfig) DeepCopy() *LogForwarderConfig {
	if in == nil {
		return nil
	}
	out := new(LogForwarderConfig)
	in.DeepCopyInto(out)
	return out
}
