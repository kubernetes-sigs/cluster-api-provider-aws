...
type TargetGroupHealthCheck struct {
	...
	// This field cannot be changed in Kube apiserver target. Use HealthCheckProtocol instead.
	// Defaults to TCP.
	...
	// otherwise the path will be ignored. This field cannot be changed in Kube apiserver target.
	// Defaults to "/readyz".
