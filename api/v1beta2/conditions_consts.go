...
// AWSCluster's VpcReady condition and corresponding reasons that will be used in v1Beta2 API version.
const (
...
// AWSCluster's SubnetsReady condition and corresponding reasons that will be used in v1Beta2 API version.
const (
...
// AWSCluster's LoadBalancerReady condition and corresponding reasons that will be used in v1Beta2 API version.
const (
...
// AWSCluster's ClusterSecurityGroupsReady condition and corresponding reasons that will be used in v1Beta2 API version.
const (
...
// AWSCluster's BastionHostReady condition and corresponding reasons that will be used in v1Beta2 API version.
const (
