...
func (in *AWSMachineStatus) DeepCopyInto(out *AWSMachineStatus) {
	*out = *in
	...
	if in.AllocatedHostID != nil {
		in, out := &in.AllocatedHostID, &out.AllocatedHostID
		*out = new(string)
		**out = **in
	}
	if in.HostReleaseAttempts != nil {
		in, out := &in.HostReleaseAttempts, &out.HostReleaseAttempts
		*out = new(int32)
		**out = **in
	}
	if in.LastHostReleaseAttempt != nil {
		in, out := &in.LastHostReleaseAttempt, &out.LastHostReleaseAttempt
		*out = (*in).DeepCopy()
	}
	if in.HostReleaseFailedReason != nil {
		in, out := &in.HostReleaseFailedReason, &out.HostReleaseFailedReason
		*out = new(string)
		**out = **in
	}
}
