...
func (in *AWSClusterStatus) DeepCopyInto(out *AWSClusterStatus) {
	*out = *in
	...
	if in.V1Beta2 != nil {
		...
		*out = new(AWSClusterV1Beta2Status)
		(*in).DeepCopyInto(*out)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AWSClusterV1Beta2Status) DeepCopyInto(out *AWSClusterV1Beta2Status) {
	*out = *in
	if in.Conditions != nil {
		in, out := &in.Conditions, &out.Conditions
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AWSClusterV1Beta2Status.
func (in *AWSClusterV1Beta2Status) DeepCopy() *AWSClusterV1Beta2Status {
	if in == nil {
		return nil
	}
	out := new(AWSClusterV1Beta2Status)
...
func (in *AWSMachineStatus) DeepCopyInto(out *AWSMachineStatus) {
	*out = *in
	...
	if in.V1Beta2 != nil {
		in, out := &in.V1Beta2, &out.V1Beta2
		*out = new(AWSMachineV1Beta2Status)
		(*in).DeepCopyInto(*out)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AWSMachineV1Beta2Status) DeepCopyInto(out *AWSMachineV1Beta2Status) {
	*out = *in
	if in.Conditions != nil {
		in, out := &in.Conditions, &out.Conditions
		*out = make([]v1.Condition, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AWSMachineV1Beta2Status.
func (in *AWSMachineV1Beta2Status) DeepCopy() *AWSMachineV1Beta2Status {
	if in == nil {
		return nil
	}
	out := new(AWSMachineV1Beta2Status)
...
func (in *AWSManagedClusterStatus) DeepCopyInto(out *AWSManagedClusterStatus) {
	*out = *in
	...
	if in.V1Beta2 != nil {
		in, out := &in.V1Beta2, &out.V1Beta2
		*out = new(AWSManagedClusterV1Beta2Status)
		(*in).DeepCopyInto(*out)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AWSManagedClusterV1Beta2Status) DeepCopyInto(out *AWSManagedClusterV1Beta2Status) {
	*out = *in
	if in.Conditions != nil {
		in, out := &in.Conditions, &out.Conditions
		*out = make([]v1.Condition, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AWSManagedClusterV1Beta2Status.
func (in *AWSManagedClusterV1Beta2Status) DeepCopy() *AWSManagedClusterV1Beta2Status {
	if in == nil {
		return nil
	}
	out := new(AWSManagedClusterV1Beta2Status)
