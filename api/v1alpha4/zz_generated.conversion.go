...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*v1beta1.AWSClusterTemplateResource)(nil), (*AWSClusterTemplateResource)(nil), func(a, b interface{}, scope conversion.Scope) error {
	...
	if err := s.AddGeneratedConversionFunc((*PolicyDocument)(nil), (*v1beta1.PolicyDocument)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha4_PolicyDocument_To_v1beta1_PolicyDocument(a.(*PolicyDocument), b.(*v1beta1.PolicyDocument), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*v1beta1.PolicyDocument)(nil), (*PolicyDocument)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1beta1_PolicyDocument_To_v1alpha4_PolicyDocument(a.(*v1beta1.PolicyDocument), b.(*PolicyDocument), scope)
	}); err != nil {
		return err
	}
	...
	if err := s.AddGeneratedConversionFunc((*StatementEntry)(nil), (*v1beta1.StatementEntry)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha4_StatementEntry_To_v1beta1_StatementEntry(a.(*StatementEntry), b.(*v1beta1.StatementEntry), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*v1beta1.StatementEntry)(nil), (*StatementEntry)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1beta1_StatementEntry_To_v1alpha4_StatementEntry(a.(*v1beta1.StatementEntry), b.(*StatementEntry), scope)
	}); err != nil {
		return err
	}
...
// Convert_v1beta1_AWSClusterTemplateResource_To_v1alpha4_AWSClusterTemplateResource is an autogenerated conversion function.
func Convert_v1beta1_AWSClusterTemplateResource_To_v1alpha4_AWSClusterTemplateResource(in *v1beta1.AWSClusterTemplateResource, out *AWSClusterTemplateResource, s conversion.Scope) error {
...
func autoConvert_v1alpha4_AWSMachineList_To_v1beta1_AWSMachineList(in *AWSMachineList, out *v1beta1.AWSMachineList, s conversion.Scope) error {
	out.ListMeta = in.ListMeta
	out.Items = *(*[]v1beta1.AWSMachine)(unsafe.Pointer(&in.Items))
	return nil
}
...
func autoConvert_v1alpha4_AWSMachineTemplateList_To_v1beta1_AWSMachineTemplateList(in *AWSMachineTemplateList, out *v1beta1.AWSMachineTemplateList, s conversion.Scope) error {
	out.ListMeta = in.ListMeta
	out.Items = *(*[]v1beta1.AWSMachineTemplate)(unsafe.Pointer(&in.Items))
	return nil
}
...
// Convert_v1beta1_AWSMachineTemplateResource_To_v1alpha4_AWSMachineTemplateResource is an autogenerated conversion function.
func Convert_v1beta1_AWSMachineTemplateResource_To_v1alpha4_AWSMachineTemplateResource(in *v1beta1.AWSMachineTemplateResource, out *AWSMachineTemplateResource, s conversion.Scope) error {
...
func autoConvert_v1alpha4_PolicyDocument_To_v1beta1_PolicyDocument(in *PolicyDocument, out *v1beta1.PolicyDocument, s conversion.Scope) error {
	out.Version = in.Version
	out.Statement = *(*v1beta1.Statements)(unsafe.Pointer(&in.Statement))
	out.ID = in.ID
	return nil
}

// Convert_v1alpha4_PolicyDocument_To_v1beta1_PolicyDocument is an autogenerated conversion function.
func Convert_v1alpha4_PolicyDocument_To_v1beta1_PolicyDocument(in *PolicyDocument, out *v1beta1.PolicyDocument, s conversion.Scope) error {
	return autoConvert_v1alpha4_PolicyDocument_To_v1beta1_PolicyDocument(in, out, s)
}

func autoConvert_v1beta1_PolicyDocument_To_v1alpha4_PolicyDocument(in *v1beta1.PolicyDocument, out *PolicyDocument, s conversion.Scope) error {
	out.Version = in.Version
	out.Statement = *(*Statements)(unsafe.Pointer(&in.Statement))
	out.ID = in.ID
	return nil
}

// Convert_v1beta1_PolicyDocument_To_v1alpha4_PolicyDocument is an autogenerated conversion function.
func Convert_v1beta1_PolicyDocument_To_v1alpha4_PolicyDocument(in *v1beta1.PolicyDocument, out *PolicyDocument, s conversion.Scope) error {
	return autoConvert_v1beta1_PolicyDocument_To_v1alpha4_PolicyDocument(in, out, s)
}
...
func autoConvert_v1alpha4_StatementEntry_To_v1beta1_StatementEntry(in *StatementEntry, out *v1beta1.StatementEntry, s conversion.Scope) error {
	out.Sid = in.Sid
	out.Principal = *(*v1beta1.Principals)(unsafe.Pointer(&in.Principal))
	out.NotPrincipal = *(*v1beta1.Principals)(unsafe.Pointer(&in.NotPrincipal))
	out.Effect = v1beta1.Effect(in.Effect)
	out.Action = *(*v1beta1.Actions)(unsafe.Pointer(&in.Action))
	out.Resource = *(*v1beta1.Resources)(unsafe.Pointer(&in.Resource))
	out.Condition = *(*v1beta1.Conditions)(unsafe.Pointer(&in.Condition))
	return nil
}

// Convert_v1alpha4_StatementEntry_To_v1beta1_StatementEntry is an autogenerated conversion function.
func Convert_v1alpha4_StatementEntry_To_v1beta1_StatementEntry(in *StatementEntry, out *v1beta1.StatementEntry, s conversion.Scope) error {
	return autoConvert_v1alpha4_StatementEntry_To_v1beta1_StatementEntry(in, out, s)
}

func autoConvert_v1beta1_StatementEntry_To_v1alpha4_StatementEntry(in *v1beta1.StatementEntry, out *StatementEntry, s conversion.Scope) error {
	out.Sid = in.Sid
	out.Principal = *(*Principals)(unsafe.Pointer(&in.Principal))
	out.NotPrincipal = *(*Principals)(unsafe.Pointer(&in.NotPrincipal))
	out.Effect = Effect(in.Effect)
	out.Action = *(*Actions)(unsafe.Pointer(&in.Action))
	out.Resource = *(*Resources)(unsafe.Pointer(&in.Resource))
	out.Condition = *(*Conditions)(unsafe.Pointer(&in.Condition))
	return nil
}

// Convert_v1beta1_StatementEntry_To_v1alpha4_StatementEntry is an autogenerated conversion function.
func Convert_v1beta1_StatementEntry_To_v1alpha4_StatementEntry(in *v1beta1.StatementEntry, out *StatementEntry, s conversion.Scope) error {
	return autoConvert_v1beta1_StatementEntry_To_v1alpha4_StatementEntry(in, out, s)
}
