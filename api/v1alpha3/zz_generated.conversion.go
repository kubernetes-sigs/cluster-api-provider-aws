...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddConversionFunc((*apiv1alpha3.APIEndpoint)(nil), (*apiUpstreamv1beta1.APIEndpoint)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha3_APIEndpoint_To_v1beta1_APIEndpoint(a.(*apiv1alpha3.APIEndpoint), b.(*apiUpstreamv1beta1.APIEndpoint), scope)
	}); err != nil {
		return err
	}
	...
	if err := s.AddConversionFunc((*apiUpstreamv1beta1.APIEndpoint)(nil), (*apiv1alpha3.APIEndpoint)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1beta1_APIEndpoint_To_v1alpha3_APIEndpoint(a.(*apiUpstreamv1beta1.APIEndpoint), b.(*apiv1alpha3.APIEndpoint), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1alpha3_AWSClusterStatus_To_v1beta1_AWSClusterStatus(in *AWSClusterStatus, out *v1beta1.AWSClusterStatus, s conversion.Scope) error {
	...
	out.FailureDomains = *(*apiUpstreamv1beta1.FailureDomains)(unsafe.Pointer(&in.FailureDomains))
	if in.Bastion != nil {
	...
	out.Conditions = *(*apiUpstreamv1beta1.Conditions)(unsafe.Pointer(&in.Conditions))
	return nil
}
...
func autoConvert_v1alpha3_AWSMachineStatus_To_v1beta1_AWSMachineStatus(in *AWSMachineStatus, out *v1beta1.AWSMachineStatus, s conversion.Scope) error {
	...
	out.Addresses = *(*[]apiUpstreamv1beta1.MachineAddress)(unsafe.Pointer(&in.Addresses))
...
// Convert_v1beta1_AWSMachineTemplateResource_To_v1alpha3_AWSMachineTemplateResource is an autogenerated conversion function.
func Convert_v1beta1_AWSMachineTemplateResource_To_v1alpha3_AWSMachineTemplateResource(in *v1beta1.AWSMachineTemplateResource, out *AWSMachineTemplateResource, s conversion.Scope) error {
