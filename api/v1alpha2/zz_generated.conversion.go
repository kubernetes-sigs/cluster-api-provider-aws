...
func autoConvert_v1alpha2_Instance_To_v1alpha1_Instance(in *Instance, out *v1alpha1.Instance, s conversion.Scope) error {
	...
	out.KeyName = (*string)(unsafe.Pointer(in.KeyName))
	out.SecurityGroupIDs = *(*[]string)(unsafe.Pointer(&in.SecurityGroupIDs))
...
// Convert_v1alpha2_Instance_To_v1alpha1_Instance is an autogenerated conversion function.
func Convert_v1alpha2_Instance_To_v1alpha1_Instance(in *Instance, out *v1alpha1.Instance, s conversion.Scope) error {
	return autoConvert_v1alpha2_Instance_To_v1alpha1_Instance(in, out, s)
}
...
// Convert_v1alpha1_Instance_To_v1alpha2_Instance is an autogenerated conversion function.
func Convert_v1alpha1_Instance_To_v1alpha2_Instance(in *v1alpha1.Instance, out *Instance, s conversion.Scope) error {
	return autoConvert_v1alpha1_Instance_To_v1alpha2_Instance(in, out, s)
}
