...
// nolint
func Convert_v1alpha1_VPCSpec_To_v1alpha2_VPCSpec(in *v1alpha1.VPCSpec, out *VPCSpec, s conversion.Scope) error { // nolint
	if err := autoConvert_v1alpha1_VPCSpec_To_v1alpha2_VPCSpec(in, out, s); err != nil {
		return err
	}
...
// nolint
func Convert_v1alpha1_SubnetSpec_To_v1alpha2_SubnetSpec(in *v1alpha1.SubnetSpec, out *SubnetSpec, s conversion.Scope) error { // nolint
	if err := autoConvert_v1alpha1_SubnetSpec_To_v1alpha2_SubnetSpec(in, out, s); err != nil {
		return err
	}
	// Discard Ipv6CidrBlockID field
	return nil
}
