...
func Convert_v1alpha3_SubnetSpec_To_v1alpha2_SubnetSpec(in *v1alpha3.SubnetSpec, out *SubnetSpec, s conversion.Scope) error { // nolint
	if err := autoConvert_v1alpha3_SubnetSpec_To_v1alpha2_SubnetSpec(in, out, s); err != nil {
		return err
	}
