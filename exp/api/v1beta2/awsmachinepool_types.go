...
type AWSMachinePoolStatus struct {
	...
	// v1beta2 groups all the fields that will be added or modified in AWSMachinePool's status with the V1Beta2 version.
	// +optional
	V1Beta2 *AWSMachinePoolV1Beta2Status `json:"v1beta2,omitempty"`
}

// AWSMachinePoolV1Beta2Status groups all the fields that will be added or modified in AWSMachinePool with the V1Beta2 version.
// See https://github.com/kubernetes-sigs/cluster-api/blob/main/docs/proposals/20240916-improve-status-in-CAPI-resources.md for more context.
type AWSMachinePoolV1Beta2Status struct {
	// conditions represents the observations of an AWSMachinePool's current state.
	// +optional
	// +listType=map
	// +listMapKey=type
...
func (r *AWSMachinePool) GetV1Beta2Conditions() []metav1.Condition {
...
func (r *AWSMachinePool) SetV1Beta2Conditions(conditions []metav1.Condition) {
	if r.Status.V1Beta2 == nil {
		r.Status.V1Beta2 = &AWSMachinePoolV1Beta2Status{}
	}
