...
func (in *OIDCConfig) DeepCopyInto(out *OIDCConfig) {
	*out = *in
	if in.ExternalAuthProviders != nil {
		...
		*out = make([]rosaapiv1beta2.ExternalAuthProvider, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
<<<<<<< HEAD
=======
func (in *OperatorRolesRef) DeepCopyInto(out *OperatorRolesRef) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new OperatorRolesRef.
func (in *OperatorRolesRef) DeepCopy() *OperatorRolesRef {
	if in == nil {
		return nil
	}
	out := new(OperatorRolesRef)
	in.DeepCopyInto(out)
	return out
}
