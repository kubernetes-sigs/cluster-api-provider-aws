...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ROSAAWS) DeepCopyInto(out *ROSAAWS) {
	*out = *in
	if in.Tags != nil {
		in, out := &in.Tags, &out.Tags
		*out = make(map[string]string, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ROSAAWS.
func (in *ROSAAWS) DeepCopy() *ROSAAWS {
	if in == nil {
		return nil
	}
	out := new(ROSAAWS)
