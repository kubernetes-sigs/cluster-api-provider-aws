...
const (
	...
	// ExternalResourceGCFinalizer allows external resources to be cleaned up on delete.
	ExternalResourceGCFinalizer = "awsexternalresourcegc.infrastructure.cluster.x-k8s.io"
)
