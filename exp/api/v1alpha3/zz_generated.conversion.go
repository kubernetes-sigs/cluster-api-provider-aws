...
import (
	...
	clusterapiproviderawsapiv1beta1 "sigs.k8s.io/cluster-api-provider-aws/api/v1beta1"
...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddConversionFunc((*clusterapiproviderawsapiv1alpha3.AWSResourceReference)(nil), (*clusterapiproviderawsapiv1beta1.AMIReference)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha3_AWSResourceReference_To_v1beta1_AMIReference(a.(*clusterapiproviderawsapiv1alpha3.AWSResourceReference), b.(*clusterapiproviderawsapiv1beta1.AMIReference), scope)
	}); err != nil {
		return err
	}
	if err := s.AddConversionFunc((*clusterapiproviderawsapiv1alpha3.AWSResourceReference)(nil), (*clusterapiproviderawsapiv1beta1.AWSResourceReference)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha3_AWSResourceReference_To_v1beta1_AWSResourceReference(a.(*clusterapiproviderawsapiv1alpha3.AWSResourceReference), b.(*clusterapiproviderawsapiv1beta1.AWSResourceReference), scope)
	}); err != nil {
		return err
	}
	if err := s.AddConversionFunc((*clusterapiproviderawsapiv1alpha3.Instance)(nil), (*clusterapiproviderawsapiv1beta1.Instance)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha3_Instance_To_v1beta1_Instance(a.(*clusterapiproviderawsapiv1alpha3.Instance), b.(*clusterapiproviderawsapiv1beta1.Instance), scope)
	}); err != nil {
		return err
	}
	if err := s.AddConversionFunc((*clusterapiproviderawsapiv1alpha3.Volume)(nil), (*clusterapiproviderawsapiv1beta1.Volume)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha3_Volume_To_v1beta1_Volume(a.(*clusterapiproviderawsapiv1alpha3.Volume), b.(*clusterapiproviderawsapiv1beta1.Volume), scope)
	}); err != nil {
		return err
	}
	if err := s.AddConversionFunc((*clusterapiproviderawsapiv1beta1.AMIReference)(nil), (*clusterapiproviderawsapiv1alpha3.AWSResourceReference)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1beta1_AMIReference_To_v1alpha3_AWSResourceReference(a.(*clusterapiproviderawsapiv1beta1.AMIReference), b.(*clusterapiproviderawsapiv1alpha3.AWSResourceReference), scope)
	}); err != nil {
		return err
	}
	...
	if err := s.AddConversionFunc((*clusterapiproviderawsapiv1beta1.AWSResourceReference)(nil), (*clusterapiproviderawsapiv1alpha3.AWSResourceReference)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1beta1_AWSResourceReference_To_v1alpha3_AWSResourceReference(a.(*clusterapiproviderawsapiv1beta1.AWSResourceReference), b.(*clusterapiproviderawsapiv1alpha3.AWSResourceReference), scope)
	}); err != nil {
		return err
	}
	if err := s.AddConversionFunc((*clusterapiproviderawsapiv1beta1.Instance)(nil), (*clusterapiproviderawsapiv1alpha3.Instance)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1beta1_Instance_To_v1alpha3_Instance(a.(*clusterapiproviderawsapiv1beta1.Instance), b.(*clusterapiproviderawsapiv1alpha3.Instance), scope)
	}); err != nil {
		return err
	}
	if err := s.AddConversionFunc((*clusterapiproviderawsapiv1beta1.Volume)(nil), (*clusterapiproviderawsapiv1alpha3.Volume)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1beta1_Volume_To_v1alpha3_Volume(a.(*clusterapiproviderawsapiv1beta1.Volume), b.(*clusterapiproviderawsapiv1alpha3.Volume), scope)
	}); err != nil {
		return err
	}
	return nil
...
func autoConvert_v1alpha3_AWSFargateProfileList_To_v1beta1_AWSFargateProfileList(in *AWSFargateProfileList, out *v1beta1.AWSFargateProfileList, s conversion.Scope) error {
	...
	out.Items = *(*[]v1beta1.AWSFargateProfile)(unsafe.Pointer(&in.Items))
	return nil
}
...
func autoConvert_v1alpha3_AWSLaunchTemplate_To_v1beta1_AWSLaunchTemplate(in *AWSLaunchTemplate, out *v1beta1.AWSLaunchTemplate, s conversion.Scope) error {
	...
	if in.RootVolume != nil {
		...
		*out = new(clusterapiproviderawsapiv1beta1.Volume)
	...
	if in.AdditionalSecurityGroups != nil {
		...
		*out = make([]clusterapiproviderawsapiv1beta1.AWSResourceReference, len(*in))
		for i := range *in {
...
func autoConvert_v1alpha3_AWSMachinePoolSpec_To_v1beta1_AWSMachinePoolSpec(in *AWSMachinePoolSpec, out *v1beta1.AWSMachinePoolSpec, s conversion.Scope) error {
	...
	out.AdditionalTags = *(*clusterapiproviderawsapiv1beta1.Tags)(unsafe.Pointer(&in.AdditionalTags))
...
func autoConvert_v1alpha3_AutoScalingGroup_To_v1beta1_AutoScalingGroup(in *AutoScalingGroup, out *v1beta1.AutoScalingGroup, s conversion.Scope) error {
	out.ID = in.ID
	out.Tags = *(*clusterapiproviderawsapiv1beta1.Tags)(unsafe.Pointer(&in.Tags))
	out.Name = in.Name
	...
	if in.Instances != nil {
		...
		*out = make([]clusterapiproviderawsapiv1beta1.Instance, len(*in))
		for i := range *in {
