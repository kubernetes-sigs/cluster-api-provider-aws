...
func (r *AWSMachinePool) ConvertTo(dstRaw conversion.Hub) error {
	...
	restored := &v1beta1.AWSMachinePool{}
...
func (r *AWSManagedMachinePool) ConvertTo(dstRaw conversion.Hub) error {
	...
	restored := &infrav1beta1exp.AWSManagedMachinePool{}
	if ok, err := utilconversion.UnmarshalData(r, restored); err != nil || !ok {
		return err
	}
...
func Convert_v1alpha3_AWSResourceReference_To_v1beta1_AWSResourceReference(in *infrav1alpha3.AWSResourceReference, out *infrav1beta1.AWSResourceReference, s apiconversion.Scope) error {
...
func Convert_v1beta1_AWSResourceReference_To_v1alpha3_AWSResourceReference(in *infrav1beta1.AWSResourceReference, out *infrav1alpha3.AWSResourceReference, s apiconversion.Scope) error {
	return infrav1alpha3.Convert_v1beta1_AWSResourceReference_To_v1alpha3_AWSResourceReference(in, out, s)
}

// Convert_v1beta1_AWSManagedMachinePoolSpec_To_v1alpha3_AWSManagedMachinePoolSpec is an autogenerated conversion function.
func Convert_v1beta1_AWSManagedMachinePoolSpec_To_v1alpha3_AWSManagedMachinePoolSpec(in *infrav1beta1exp.AWSManagedMachinePoolSpec, out *AWSManagedMachinePoolSpec, s apiconversion.Scope) error {
...
func Convert_v1beta1_AMIReference_To_v1alpha3_AWSResourceReference(in *infrav1beta1.AMIReference, out *infrav1alpha3.AWSResourceReference, s apiconversion.Scope) error {
	return infrav1alpha3.Convert_v1beta1_AMIReference_To_v1alpha3_AWSResourceReference(in, out, s)
}

// Convert_v1beta1_Volume_To_v1alpha3_Volume is an autogenerated conversion function.
func Convert_v1beta1_Volume_To_v1alpha3_Volume(in *infrav1beta1.Volume, out *infrav1alpha3.Volume, s apiconversion.Scope) error {
...
func Convert_v1alpha3_Volume_To_v1beta1_Volume(in *infrav1alpha3.Volume, out *infrav1beta1.Volume, s apiconversion.Scope) error {
