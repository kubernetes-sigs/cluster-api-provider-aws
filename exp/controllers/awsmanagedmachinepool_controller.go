...
// These 3 should probably be in cluster-api
...
func machinePoolToInfrastructureMapFunc(gvk schema.GroupVersionKind) handler.ToRequestsFunc {
	return func(o handler.MapObject) []reconcile.Request {
		c, ok := o.Object.(*capiv1exp.MachinePool)
		if !ok {
			return nil
		}
		...
		infraGK := c.Spec.Template.Spec.InfrastructureRef.GroupVersionKind().GroupKind()
		if gk != infraGK {
			return nil
		}
		...
		return []reconcile.Request{
			{
				NamespacedName: client.ObjectKey{
					...
					Name:      c.Spec.Template.Spec.InfrastructureRef.Name,
				},
			},
		}
	}
