...
func (r *ROSAOCMRoleConfigReconciler) reconcileOCMRole(_ context.Context, scope *scope.ROSAOCMRoleConfigScope, rt *rosacli.Runtime) (ctrl.Result, error) {
	...
	if linked {
		scope.Info("Successfully linked OCM role to organization", "roleARN", roleARN, "orgID", orgID)
		...
		scope.Info("OCM role already linked to organization", "roleARN", roleARN, "orgID", orgID)
	}
