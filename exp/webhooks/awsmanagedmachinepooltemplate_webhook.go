...
func (w *AWSManagedMachinePoolTemplate) SetupWebhookWithManager(mgr ctrl.Manager) error {
	return ctrl.NewWebhookManagedBy(mgr, &expinfrav1.AWSManagedMachinePoolTemplate{}).
...
func (w *AWSManagedMachinePoolTemplate) ValidateCreate(_ context.Context, obj runtime.Object) (admission.Warnings, error) {
	...
	if spec.ProviderIDList != nil {
		allErrs = append(allErrs, field.Forbidden(specPath.Child("providerIDList"), "cannot be set in templates"))
	}
	...
	return nil, apierrors.NewInvalid(
		schema.GroupKind{Group: infrastructureGroup, Kind: "AWSManagedMachinePoolTemplate"},
		r.Name,
		allErrs,
	)
}
...
func (w *AWSManagedMachinePoolTemplate) ValidateUpdate(_ context.Context, oldObj, newObj runtime.Object) (admission.Warnings, error) {
	...
	newTemplate, ok := newObj.(*expinfrav1.AWSManagedMachinePoolTemplate)
	if !ok {
