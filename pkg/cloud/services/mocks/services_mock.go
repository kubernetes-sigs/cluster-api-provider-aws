...
// Source: sigs.k8s.io/cluster-api-provider-aws/pkg/cloud/services (interfaces: EC2Interface,ELBInterface)
...
func (m *MockEC2Interface) CreateOrGetMachine(arg0 *scope.MachineScope) (*v1alpha2.Instance, error) {
	m.ctrl.T.Helper()
