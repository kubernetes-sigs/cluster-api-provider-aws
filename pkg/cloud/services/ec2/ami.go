...
func (s *Service) eksAMILookup(kubernetesVersion string, amiType *v1beta1.EKSAMILookupType) (string, error) {
	...
	if amiType == nil {
		amiType = new(v1beta1.EKSAMILookupType)
	}

	switch *amiType {
	case v1beta1.AmazonLinuxGPU:
