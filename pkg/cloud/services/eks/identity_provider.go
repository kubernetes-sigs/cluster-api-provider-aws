...
import (
	...
	eksv1 "sigs.k8s.io/cluster-api-provider-aws/controlplane/eks/api/v1beta1"
...
func (s *Service) reconcileIdentityProvider(ctx context.Context) error {
	...
	if latest != nil {
		s.scope.ControlPlane.Status.IdentityProviderStatus = eksv1.IdentityProviderStatus{
