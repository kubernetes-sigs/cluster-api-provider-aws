...
func (s *Service) buildOIDCTrustPolicy() v1beta1.PolicyDocument {
	providerARN := s.scope.ControlPlane.Status.OIDCProvider.ARN
	...
	return v1beta1.PolicyDocument{
		...
		Statement: v1beta1.Statements{
			v1beta1.StatementEntry{
				Sid:    "",
				Effect: "Allow",
				Principal: v1beta1.Principals{
					v1beta1.PrincipalFederated: v1beta1.PrincipalID{providerARN},
				},
				Action: v1beta1.Actions{"sts:AssumeRoleWithWebIdentity"},
