...
//
//go:generate ../../../../../hack/tools/bin/mockgen -destination sqsiface_mock.go -package mock_sqsiface sigs.k8s.io/cluster-api-provider-aws/v2/pkg/cloud/services/instancestate SQSAPI
