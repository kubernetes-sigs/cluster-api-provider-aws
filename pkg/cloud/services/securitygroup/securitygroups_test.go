...
func TestDeleteSecurityGroups(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			expect: func(m *mocks.MockEC2APIMockRecorder) {
				m.DescribeSecurityGroups(context.TODO(), gomock.AssignableToTypeOf(&ec2.DescribeSecurityGroupsInput{})).Return(&ec2.DescribeSecurityGroupsOutput{}, nil)
			},
		},
		{
		...
		},
		{
			...
			expect: func(m *mocks.MockEC2APIMockRecorder) {
				m.DescribeSecurityGroups(context.TODO(), gomock.AssignableToTypeOf(&ec2.DescribeSecurityGroupsInput{})).Return(&ec2.DescribeSecurityGroupsOutput{}, awserrors.NewFailedDependency("dependency-failure"))
			},
			wantErr: true,
		},
		{
			...
			expect: func(m *mocks.MockEC2APIMockRecorder) {
				m.DescribeSecurityGroups(context.TODO(), gomock.AssignableToTypeOf(&ec2.DescribeSecurityGroupsInput{})).Return(nil, awserr.New("dependency-failure", "dependency-failure", errors.Errorf("dependency-failure")))
			},
			wantErr: true,
		},
		{
			...
			expect: func(m *mocks.MockEC2APIMockRecorder) {
				m.DescribeSecurityGroups(context.TODO(), gomock.AssignableToTypeOf(&ec2.DescribeSecurityGroupsInput{})).Return(&ec2.DescribeSecurityGroupsOutput{
					SecurityGroups: []types.SecurityGroup{
						{
		...
		},
		{
			...
			expect: func(m *mocks.MockEC2APIMockRecorder) {
				...
				m.RevokeSecurityGroupIngress(context.TODO(), gomock.AssignableToTypeOf(&ec2.RevokeSecurityGroupIngressInput{})).Return(nil, awserr.New("failure", "failure", errors.Errorf("failure")))
			},
			wantErr: true,
		},
		{
