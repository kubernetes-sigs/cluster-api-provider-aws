...
func NewROSANetworkScope(params ROSANetworkScopeParams) (*ROSANetworkScope, error) {
	...
	session, serviceLimiters, err := sessionForClusterWithRegionV2(params.Client, rosaNetworkScope, params.ROSANetwork.Spec.Region, params.Endpoints, params.Logger)
	if err != nil {
