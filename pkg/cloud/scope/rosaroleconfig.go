...
func NewRosaRoleConfigScope(params RosaRoleConfigScopeParams) (*RosaRoleConfigScope, error) {
	...
	session, serviceLimiters, err := sessionForClusterWithRegion(params.Client, RosaRoleConfigScope, params.RosaRoleConfig.Spec.Region, params.Endpoints, params.Logger)
	if err != nil {
...
func convertAWSIdentityReference(expRef *expinfrav1.AWSIdentityReference) *infrav1.AWSIdentityReference {
	ref := infrav1.AWSIdentityReference{
		Name: expRef.Name,
		Kind: infrav1.AWSIdentityKind(expRef.Kind),
	}
	return &ref
}
...
func (s *RosaRoleConfigScope) IdentityRef() *infrav1.AWSIdentityReference {
	return convertAWSIdentityReference(s.RosaRoleConfig.Spec.IdentityRef)
}
