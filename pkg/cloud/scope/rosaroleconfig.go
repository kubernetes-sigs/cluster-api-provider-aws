...
import (
	...
	RosaRoleConfigv1 "sigs.k8s.io/cluster-api-provider-aws/v2/api/v1beta2"
...
type RosaRoleConfigScopeParams struct {
	...
	RosaRoleConfig *infrav1.ROSARoleConfig
}
...
func (s *RosaRoleConfigScope) PatchObject() error {
	return s.patchHelper.Patch(
		...
		patch.WithOwnedConditions{Conditions: []clusterv1.ConditionType{
			RosaRoleConfigv1.RosaRoleConfigReadyCondition,
		}})
}
