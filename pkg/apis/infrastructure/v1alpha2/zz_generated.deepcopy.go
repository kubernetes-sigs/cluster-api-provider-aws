...
func (in *AWSClusterProviderSpec) DeepCopyInto(out *AWSClusterProviderSpec) {
	*out = *in
	...
	if in.CAKeyPair != nil {
		in, out := &in.CAKeyPair, &out.CAKeyPair
		*out = new(KeyPair)
		(*in).DeepCopyInto(*out)
	}
	if in.EtcdCAKeyPair != nil {
		in, out := &in.EtcdCAKeyPair, &out.EtcdCAKeyPair
		*out = new(KeyPair)
		(*in).DeepCopyInto(*out)
	}
	if in.FrontProxyCAKeyPair != nil {
		in, out := &in.FrontProxyCAKeyPair, &out.FrontProxyCAKeyPair
		*out = new(KeyPair)
		(*in).DeepCopyInto(*out)
	}
	if in.SAKeyPair != nil {
		in, out := &in.SAKeyPair, &out.SAKeyPair
		*out = new(KeyPair)
		(*in).DeepCopyInto(*out)
	}
