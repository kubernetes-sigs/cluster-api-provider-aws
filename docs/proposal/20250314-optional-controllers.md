...
This current proposal includes the ability to disable `AWSMachine` and `AWSCluster` as a compromise; it achieves the goals of the original proposal, while addressing the objections to the proposed implementation.
