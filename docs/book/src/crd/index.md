...
<ul>
<li>
<a href="#ami.aws.infrastructure.cluster.x-k8s.io%2fv1alpha1">ami.aws.infrastructure.cluster.x-k8s.io/v1alpha1</a>
</li>
<li>
...
<h2 id="ami.aws.infrastructure.cluster.x-k8s.io/v1alpha1">ami.aws.infrastructure.cluster.x-k8s.io/v1alpha1</h2>
<p>
<p>Package v1alpha1 contains API Schema definitions for the ami v1alpha1 API group</p>
</p>
Resource Types:
<ul></ul>
<h3 id="ami.aws.infrastructure.cluster.x-k8s.io/v1alpha1.AWSAMI">AWSAMI
</h3>
<p>
...
<code>spec</code><br/>
<em>
<a href="#ami.aws.infrastructure.cluster.x-k8s.io/v1alpha1.AWSAMISpec">
AWSAMISpec
</a>
</em>
</td>
...
<h3 id="ami.aws.infrastructure.cluster.x-k8s.io/v1alpha1.AWSAMISpec">AWSAMISpec
</h3>
<p>
(<em>Appears on:</em><a href="#ami.aws.infrastructure.cluster.x-k8s.io/v1alpha1.AWSAMI">AWSAMI</a>)
</p>
<p>
...
<em>
<a href="https://cluster-api-aws.sigs.k8s.io/crd/cluster-api-aws.html#infrastructure.cluster.x-k8s.io/v1alpha4.SecretBackend">
[]Cluster API AWS api/v1alpha4.SecretBackend
</a>
</em>
</td>
<td>
...
<em>
<a href="https://cluster-api-aws.sigs.k8s.io/crd/cluster-api-aws.html#infrastructure.cluster.x-k8s.io/v1alpha4.StatementEntry">
[]Cluster API AWS api/v1alpha4.StatementEntry
</a>
</em>
</td>
<td>
...
See &ldquo;sigs.k8s.io/cluster-api-provider-aws/cmd/clusterawsadm/api/iam/v1alpha1&rdquo; for more documentation.</p>
</td>
</tr>
<tr>
<td>
...
<p>
<p>Package v1alpha4 contains API Schema definitions for the controlplane v1alpha4 API group</p>
</p>
Resource Types:
<ul></ul>
...
on git commit <code>f6298212</code>.
</em></p>
