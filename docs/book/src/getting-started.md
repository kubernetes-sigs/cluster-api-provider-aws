...
See [`clusterctl init`](./topics/clusterctl/commands/init.md) for more details.
...
It is also possible but **not recommended** to disable the per-default enabled [Pod Security Standard](./topics/security/pod-security-standards.md):
```bash
...
<!-- links -->
[Experimental Features]: ./topics/tasks/experimental-features/experimental-features.md
...
[bootstrap cluster]: ./topic/reference/glossary.md#bootstrap-cluster
...
[clusterctl generate cluster]: ./topics/clusterctl/commands/generate-cluster.md
[clusterctl get kubeconfig]: ./topics/clusterctl/commands/get-kubeconfig.md
[clusterctl]: ./topics/clusterctl/overview.md
...
[infrastructure provider]: ./topics/reference/glossary.md#infrastructure-provider
[kind]: https://kind.sigs.k8s.io/
[KubeadmControlPlane]: ./topics/developer/architecture/controllers/control-plane.md
[kubectl]: https://kubernetes.io/docs/tasks/tools/install-kubectl/
[management cluster]: ./topics/reference/glossary.md#management-cluster
...
[provider]:./topics/reference/providers.md
[provider components]: ./topics/reference/glossary.md#provider-components
...
[workload cluster]: ./topics/reference/glossary.md#workload-cluster
