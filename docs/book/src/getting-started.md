...
It is also possible but **not recommended** to disable the per-default enabled [Pod Security Standard](https://github.com/kubernetes-sigs/cluster-api/blob/main/docs/book/src/security/pod-security-standards.md):
```bash
