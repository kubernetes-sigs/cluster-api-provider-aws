...
E2E_CONF_PATH="${PWD}/test/e2e_new/config/aws-ci.yaml"
...
make clusterawsadm
AWS_B64ENCODED_CREDENTIALS=$(bin/clusterawsadm alpha bootstrap encode-aws-credentials)
export AWS_B64ENCODED_CREDENTIALS
make test-e2e-new TAG=ci ARTIFACTS=$ARTIFACTS E2E_CONF_PATH=$E2E_CONF_PATH
test_status="${?}"
