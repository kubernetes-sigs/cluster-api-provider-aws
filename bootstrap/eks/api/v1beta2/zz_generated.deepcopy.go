...
func (in *EKSConfigStatus) DeepCopyInto(out *EKSConfigStatus) {
	*out = *in
	...
	if in.V1Beta2 != nil {
		...
		*out = new(EKSConfigV1Beta2Status)
		(*in).DeepCopyInto(*out)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *EKSConfigV1Beta2Status) DeepCopyInto(out *EKSConfigV1Beta2Status) {
	*out = *in
	if in.Conditions != nil {
		in, out := &in.Conditions, &out.Conditions
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new EKSConfigV1Beta2Status.
func (in *EKSConfigV1Beta2Status) DeepCopy() *EKSConfigV1Beta2Status {
	if in == nil {
		return nil
	}
	out := new(EKSConfigV1Beta2Status)
