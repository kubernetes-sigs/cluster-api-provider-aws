...
// EKSConfigTemplate implements a custom validation webhook for EKSConfigTemplate.
type EKSConfigTemplate struct{}

// SetupWebhookWithManager will setup the webhooks for the EKSConfigTemplate.
func (w *EKSConfigTemplate) SetupWebhookWithManager(mgr ctrl.Manager) error {
	return ctrl.NewWebhookManagedBy(mgr, &eksbootstrapv1.EKSConfigTemplate{}).
...
func (w *EKSConfigTemplate) ValidateCreate(_ context.Context, _ runtime.Object) (admission.Warnings, error) {
	return nil, nil
}

// ValidateUpdate will do any extra validation when updating a EKSConfigTemplate.
func (w *EKSConfigTemplate) ValidateUpdate(_ context.Context, _, _ runtime.Object) (admission.Warnings, error) {
	return nil, nil
}

// ValidateDelete allows you to add any extra validation when deleting.
func (w *EKSConfigTemplate) ValidateDelete(_ context.Context, _ runtime.Object) (admission.Warnings, error) {
	return nil, nil
}

// Default will set default values for the EKSConfigTemplate.
func (w *EKSConfigTemplate) Default(_ context.Context, _ runtime.Object) error {
	return nil
}
