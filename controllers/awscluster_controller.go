...
// +kubebuilder:rbac:groups=infrastructure.cluster.x-k8s.io,resources=awsclusterroleprincipals;awsclusterstaticprincipals;awsserviceaccountprincipals,verbs=get;list;watch;create;update;patch;delete
